...
def get_scraper(name: str, **kwargs: Any) -> JobScraper:
    ...
    scrapers: dict[str, type[JobScraper]] = {
        ...
        "hays_au": HaysAUScraper,
        "roberthalf_au": RobertHalfAUScraper,
        "michaelpage_au": MichaelPageAUScraper,
        "hudson_au": HudsonAUScraper,
        ...
        "internatjobs_de": InternatJobsDEScraper,
        "experteer_de": ExperteerDEScraper,
        "monster_de": MonsterDEScraper,
